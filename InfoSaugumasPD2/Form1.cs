            ...
            try
            {
                ...
                if (canRun != false)
                {
                    if (modeList.SelectedItem.ToString() == "CBC")
                    {
                        ...
                        File.WriteAllText(@"C:\Users\ASUS\Desktop\VIKO\2 Kursas\S2\Informacijos Saugumas\InfoSaugumasPD2\EncryptedCBC.txt", encryptedTxt.Text);
                ...
                */
                ...
                if (canRun != false)
                {
                    if (modeList.SelectedItem.ToString() == "CBC")
                    {
                        ...
                        File.WriteAllText(@"C:\Users\ASUS\Desktop\VIKO\2 Kursas\S2\Informacijos Saugumas\InfoSaugumasPD2\DecryptedCBC.txt", decryptedTxt.Text);
                    }
